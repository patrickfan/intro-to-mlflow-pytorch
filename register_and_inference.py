...
def register_and_serve(run_id, model_name="MNIST_CNN_Official"):
    client = MlflowClient()
    ...
    # Inference from different version 
    # prod_uri = f"models:/{model_name}/{version}"
    # print(f"\n Loading model from URI: {prod_uri}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="MNIST_CNN_Official", help="Registered Model Name")
